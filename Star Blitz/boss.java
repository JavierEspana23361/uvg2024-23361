...
public class boss extends World
{
    ...
    private void prepare()
    {
        ...
        addObject(worm13,287,163);
        Worm worm14 = new Worm();
        addObject(worm14,273,270);
        worm13.setLocation(280,139);
        worm14.setLocation(277,216);
        worm.setLocation(67,84);
        lobster6.setLocation(288,31);
        worm13.setLocation(175,160);
        worm14.setLocation(419,173);
        worm13.setLocation(153,190);
    }
